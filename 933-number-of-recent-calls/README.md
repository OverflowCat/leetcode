...
<p>It is <strong fr-fix-stroke="true">guaranteed</strong> that every call to <code>ping</code> uses a strictly larger value of <code>t</code> than the previous call.</p>

<p>&nbsp;</p>
<p><strong fr-fix-stroke="true">Example 1:</strong></p>

<pre><strong fr-fix-stroke="true">Input</strong>
...
<ul>
	...
	<li>Each test case will call <code>ping</code> with <strong fr-fix-stroke="true">strictly increasing</strong> values of <code>t</code>.</li>
