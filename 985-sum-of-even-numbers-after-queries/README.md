...
<pre><strong fr-fix-stroke="true">Input:</strong> nums = [1,2,3,4], queries = [[1,0],[-3,1],[-4,0],[2,3]]
<strong fr-fix-stroke="true">Output:</strong> [8,6,2,4]
<strong fr-fix-stroke="true">Explanation:</strong> At the beginning, the array is [1,2,3,4].
...
<pre><strong fr-fix-stroke="true">Input:</strong> nums = [1], queries = [[4,0]]
